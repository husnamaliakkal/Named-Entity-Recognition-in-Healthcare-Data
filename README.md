...
Suppose you have been asked to determine the disease name and its probable treatment from the dataset, we can build an algorithm to map the diseases and their respective treatment.

This project aims to understand the application of NER in healthcare.
